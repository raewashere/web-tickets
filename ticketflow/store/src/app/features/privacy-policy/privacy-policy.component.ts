    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-10">
      ...
      <div class="bg-white rounded-3xl border border-slate-200 p-6 sm:p-10 shadow-sm space-y-8 text-sm sm:text-base text-slate-700 leading-relaxed">
        ...
        <section class="space-y-3">
          <h2 class="text-lg sm:text-xl font-extrabold text-slate-900 flex items-center gap-2">
            <span>🏢</span> 1. Responsable del Tratamiento de Datos
          </h2>
          <p>
        ...
        <section class="space-y-3">
          <h2 class="text-lg sm:text-xl font-extrabold text-slate-900 flex items-center gap-2">
            <span>📋</span> 2. Información que Recopilamos
          </h2>
          ...
          <p class="text-xs text-slate-500 bg-slate-50 p-3.5 rounded-2xl border border-slate-200">
            🔒 <em>Nota sobre pagos:</em> TicketFlow no almacena ni procesa números de tarjetas de crédito o débito en sus propios servidores. Todas las transacciones son gestionadas de forma cifrada a través de pasarelas de pago certificadas internacionalmente como <strong>PayPal</strong>.
          </p>
        </section>
        ...
        <section class="space-y-3">
          <h2 class="text-lg sm:text-xl font-extrabold text-slate-900 flex items-center gap-2">
            <span>🎯</span> 3. Finalidades del Tratamiento
          </h2>
        ...
        <section class="space-y-3">
          <h2 class="text-lg sm:text-xl font-extrabold text-slate-900 flex items-center gap-2">
            <span>🛡️</span> 4. Seguridad y Almacenamiento
          </h2>
          <p>
        ...
        <section class="space-y-3">
          <h2 class="text-lg sm:text-xl font-extrabold text-slate-900 flex items-center gap-2">
            <span>⚖️</span> 5. Ejercicio de Derechos ARCO
          </h2>
          <p>
        ...
        <section class="space-y-3">
          <h2 class="text-lg sm:text-xl font-extrabold text-slate-900 flex items-center gap-2">
            <span>🍪</span> 6. Uso de Cookies y Almacenamiento Local
          </h2>
          <p>
        ...
        <section class="space-y-3">
          <h2 class="text-lg sm:text-xl font-extrabold text-slate-900 flex items-center gap-2">
            <span>📝</span> 7. Modificaciones al Aviso de Privacidad
          </h2>
          <p>
      ...
      <div class="text-center pt-4">
        <a routerLink="/">
          <button
            type="button"
            class="px-6 py-3 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs transition-colors shadow-sm"
          >
            ← Volver al Inicio
          </button>
        </a>
