      ...
      >
        <div class="space-y-1 text-center md:text-left">
          <h3 class="text-lg font-bold text-white flex items-center justify-center md:justify-start gap-2">
            <span>✨</span> Completa tu Perfil de Artista
          </h3>
        ...
        <a routerLink="/artist/profile">
          <tf-button variant="accent" size="lg">Configurar Ahora →</tf-button>
        </a>
      </div>
          ...
          <div class="lg:col-span-2 space-y-4">
            <tf-card title="Próximos Eventos Publicados" subtitle="Eventos en curso con venta de boletos activa">
              <div *ngIf="upcomingEvents().length === 0" class="py-12 text-center text-dark/50">
                ...
                <div class="mt-4">
                  <a routerLink="/events">
                    <tf-button variant="primary" size="sm">Crear Evento</tf-button>
                  </a>
                </div>
              </div>
                ...
                >
                  ...
                  <div class="flex items-center gap-3">
                    ...
                    <a [routerLink]="['/events', event.id]">
                      <tf-button variant="ghost" size="sm">Ver →</tf-button>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <tf-card title="Accesos Rápidos">
              <div class="space-y-3">
                ...
                >
                  ...
                  <span class="text-dark/40 group-hover:translate-x-1 transition-transform">→</span>
                </a>
